...
github_pat          = "13c6470da2bcc7914df58e4aad86f3ad70122c42"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "Estimatr" do |vapro|
  end
  ...
  config.vm.provision "shell", path: "#{github_url}/scripts/composer.sh", privileged: false, args: [" 13c6470da2bcc7914df58e4aad86f3ad70122c42", composer_packages.join(" ")]
